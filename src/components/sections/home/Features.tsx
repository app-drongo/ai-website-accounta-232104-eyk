...
const DEFAULT_FEATURES = {
  ...
  feature4Description:
    'Handle multiple businesses, subsidiaries, and client accounts from a single unified dashboard.',
  feature4Badge: 'Multi-Business',
  feature5Title: 'Advanced Financial Reports',
  feature5Description:
    'Generate P&L statements, balance sheets, cash flow reports, and custom financial analytics with one click.',
  feature5Badge: 'Reporting',
  feature6Title: 'Automated Workflows',
  feature6Description:
    'Set up recurring invoices, payment reminders, and expense approvals to save hours of manual work.',
  feature6Badge: 'Automation',
  feature7Title: 'Banking & Payment APIs',
  feature7Description:
    'Seamlessly connect with 12,000+ banks and integrate with PayPal, Stripe, and QuickBooks via secure APIs.',
  feature7Badge: 'Integration',
  feature8Title: '24/7 CPA Support',
  feature8Description:
    'Get expert accounting guidance from certified professionals with guaranteed response times.',
