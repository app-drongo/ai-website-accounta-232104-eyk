...
const DEFAULT_HERO = {
  ...
  titleHighlight: 'Accounta Pro',
  description:
    'Complete accounting solution designed for small businesses. Automate bookkeeping, track expenses, and generate financial reports in minutes, not hours.',
  features: [
