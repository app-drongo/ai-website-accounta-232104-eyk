...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    'Join thousands of small businesses who trust Accounta for their accounting needs. Our team of financial experts is here to help you get started.',
  ...
  office3City: 'Toronto',
  office3Address: 'Financial Core, 100 King Street W',
  ...
  supportNote: 'Priority support included with all Business and Enterprise plans',
